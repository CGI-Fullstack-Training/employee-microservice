...
public class EmployeeController {
	...
	public ResponseEntity<?> createEmployees(@RequestBody Employee employee) {
		Department department = restTemplate.getForObject(
				"http://localhost:8082/department-microservice/departments/{employeeId}", Department.class,
				Map.of("employeeId", employee.getDepartmentId()));
		if (department == null) {
			throw new DepartmentNotFoundException(
					"Department with department id " + employee.getDepartmentId() + " not found");
		}
